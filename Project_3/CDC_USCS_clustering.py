...
def main():
	...
	scatterPlot(cluster_vals, silh_score_list, "cluster size", "silh. score",'silhouette score by cluster size'+cluster_type, True)
	...
	scatterPlot2(added_CDC_Data['AreaOrig'], added_CDC_Data['AgeAdjustedRate'], "state", "rate", "rate by state"+cluster_type, True, cluster_labels_list)
	scatterPlot2(added_CDC_Data['regionOrig'], added_CDC_Data['AgeAdjustedRate'], "region", "rate", "rate by region"+cluster_type, True, cluster_labels_list)
	scatterPlot2(added_CDC_Data['datavalue_level'], added_CDC_Data['AgeAdjustedRate'], "rate bin", "rate", "rate by rate bin"+cluster_type, True, cluster_labels_list)
